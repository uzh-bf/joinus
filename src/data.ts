...
export const projects = {
  ...
  dynamics: {
    ...
    desc: `Das Weiterbildungsteam setzt für ihre Kundenverwaltung Microsoft Dynamics CRM ein. Der gesamte Teilnehmerworkflow ist darin abgebildet:
      ...
      man nun auf die Daten zugreifen, sodass diese direkt auf der Webseite dargestellt werden können. Hier halten wir uns an das "single source of truth" Prinzip'.`,
  ...
  /*redesign: {
    ...
    desc: `Die Universität Zürich verwendet seit langem Magnolia als Content Management System (CMS).
          Die Webseite unseres Instituts basierte aber lange Zeit noch auf dem in Contao eingebetteten Vorgänger.
          Im Rahmen eines umfassenden Redesigns wurde die Webseite auf Magnolia umgestellt sowie um neue Elemente wie die Mitarbeiter-
          oder Vorlesungsübersicht erweitert. Wo die Möglichkeiten des CMS nicht ausreichten, wurden diese mit PHP und Javascript ergänzt.
          Im Hintergrund werden die Daten in einer von uns entwickelten MySQL Datenbank gespeichert, auf die wir mit einer PHP API zugreifen.
          Anschliessend werden die Daten visualisiert. Alle Daten externer Quellen werden bei uns gecached,
          mit nächtlich durchlaufende Skripts werden diese aktualisiert.`,
    cite: `Obwohl die neue Webseite der alten aufgrund der Corporate Identity Bestimmungen der UZH sehr ähnelt,
      ist die technische Grundlage komplett neu. Mit eigenentwickelten Komponenten versuchen wir die Nachteile
...
export const teams = [
  {
    ...
    leaderPosition: 'IT Leating Kommunikation und Leitung des Web Teams IBF',
    teamDescription: `Bei mir steht ein grosses Update der Institut Website vor, mit decoupled Komponenten in React die alle neu konzipiert werden müssen. Zudem brauche ich immer Verstärkung in Support.`,
  },
  {
