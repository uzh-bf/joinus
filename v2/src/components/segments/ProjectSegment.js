...
class ProjectSegment extends Component {
  ...
  showKlicker = () => {
    this.showProject('klicker')
  }
  showDynamics = () => {
    this.showProject('dynamics')
  }
  showRedesign = () => {
    this.showProject('redesign')
  }
  showTools = () => {
    this.showProject('tools')
  }
  showLehr = () => {
    this.showProject('lehrveranstaltungen')
  }
  showJobeye = () => {
    this.showProject('jobeye')
  }
              ...
              >
                ...
                >
                  <Grid.Column width={6}>
                    {this.state.show && (
                      <Image
                        src={'images/' + this.mapping[this.state.showWhat].img}
                      />
                    )}
                  </Grid.Column>
                  <Grid.Column width={10}>
                    {this.state.show && [
                      ...
                      <br />,
                      <i>
                        <p>{this.mapping[this.state.showWhat].cite}</p>
                      </i>,
                      ...
                      this.mapping[this.state.showWhat].cite2 && [
                        <br />,
                        <i>
                          <p>{this.mapping[this.state.showWhat].cite2}</p>
                        </i>,
                        <Header as="h5" textAlign="right">
